function good_tracks = goThroughBeadTracksVideo(image_label,data_set_label,n_traj_start,n_traj_end,minPointsTraj) 
%
% ========================================
% BeadTracking_MT.
...
% gt = goThroughBeadTracksVideo('1757_1','datasetA',1,'end',3);
% gt = goThroughBeadTracksVideo('498','tests1',1,'end',6);
% ------------------------------------
